...
public class IntBean {
	...
	public IntBean(final int int1, final int int2, final int int3, final int int4, final int int5, final int int6, final int int7, final int int8, final int int9, final int int10) {
		this.int1 = int1;
		this.int2 = int2;
		this.int3 = int3;
		this.int4 = int4;
